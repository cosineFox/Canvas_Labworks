...
<style>
	...
	@media (max-width: 960px) { .content { grid-template-columns: 1fr; } .about-section, .counter-box, .links-section { grid-column: auto; } .feed-section { grid-row: auto; } .about { grid-template-columns: 1fr; text-align: center; gap: 15px; } .info-list { justify-content: center; } }
</style>
